...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2006"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2006"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2006"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2006/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2006 = master_df_10k[master_df_10k["year"] == "2006"]
master_df_10k_2006["url_cut"] = master_df_10k_2006.apply(lambda row: row["url"][29:] ,axis=1)

final_2006_text = pd.merge(new, master_df_10k_2006, on="url_cut")
final_2006_text.CIK = final_2006_text.CIK.astype(int)
final_2006_text.cik = final_2006_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2006_cik = []# This is list of CIKs that are identified as fraudulent
final_2006_text["fraud"] = np.where(final_2006_text["cik"].isin(fraud_2006_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2006_text = final_2006_text[cols]
final_2006_text['text'] = final_2006_text['text'].apply(lambda x: x.replace("\n",''))
final_2006_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2006/final_2006_text.csv", index = False)