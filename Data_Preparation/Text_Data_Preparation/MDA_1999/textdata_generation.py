...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1999"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1999"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1999"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1999/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_1999 = master_df_10k[master_df_10k["year"] == "1999"]
master_df_10k_1999["url_cut"] = master_df_10k_1999.apply(lambda row: row["url"][29:] ,axis=1)

final_1999_text = pd.merge(new, master_df_10k_1999, on="url_cut")
final_1999_text.CIK = final_1999_text.CIK.astype(int)
final_1999_text.cik = final_1999_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_1999_cik = []# This is list of CIKs that are identified as fraudulent
final_1999_text["fraud"] = np.where(final_1999_text["cik"].isin(fraud_1999_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_1999_text = final_1999_text[cols]
final_1999_text['text'] = final_1999_text['text'].apply(lambda x: x.replace("\n",''))
final_1999_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1999/final_1999_text.csv", index = False)