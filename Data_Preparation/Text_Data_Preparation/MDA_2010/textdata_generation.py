...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2010"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2010"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2010"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2010/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2010 = master_df_10k[master_df_10k["year"] == "2010"]
master_df_10k_2010["url_cut"] = master_df_10k_2010.apply(lambda row: row["url"][29:] ,axis=1)

final_2010_text = pd.merge(new, master_df_10k_2010, on="url_cut")
final_2010_text.CIK = final_2010_text.CIK.astype(int)
final_2010_text.cik = final_2010_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2010_cik = []# This is list of CIKs that are identified as fraudulent
final_2010_text["fraud"] = np.where(final_2010_text["cik"].isin(fraud_2010_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2010_text = final_2010_text[cols]
final_2010_text['text'] = final_2010_text['text'].apply(lambda x: x.replace("\n",''))
final_2010_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2010/final_2010_text.csv", index = False)