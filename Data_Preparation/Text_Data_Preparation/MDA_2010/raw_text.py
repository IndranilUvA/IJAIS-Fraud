...
id = [i for i in range(1,master_df_10k_2010.shape[0]+1)]
d = {'id': id, 'col2': master_df_10k_2010["url_cut"]}
df = pd.DataFrame(data=d)
df.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2010/downloadlist.txt", sep=',', index=False, header=False)
