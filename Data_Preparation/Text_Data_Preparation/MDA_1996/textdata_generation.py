...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1996"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1996"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1996"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1996/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_1996 = master_df_10k[master_df_10k["year"] == "1996"]
master_df_10k_1996["url_cut"] = master_df_10k_1996.apply(lambda row: row["url"][29:] ,axis=1)

final_1996_text = pd.merge(new, master_df_10k_1996, on="url_cut")
final_1996_text.CIK = final_1996_text.CIK.astype(int)
final_1996_text.cik = final_1996_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_1996_cik = []# This is list of CIKs that are identified as fraudulent
final_1996_text["fraud"] = np.where(final_1996_text["cik"].isin(fraud_1996_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_1996_text = final_1996_text[cols]
final_1996_text['text'] = final_1996_text['text'].apply(lambda x: x.replace("\n",''))
final_1996_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1996/final_1996_text.csv", index = False)