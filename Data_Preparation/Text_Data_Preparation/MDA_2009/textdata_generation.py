...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2009"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2009"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2009"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2009/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2009 = master_df_10k[master_df_10k["year"] == "2009"]
master_df_10k_2009["url_cut"] = master_df_10k_2009.apply(lambda row: row["url"][29:] ,axis=1)

final_2009_text = pd.merge(new, master_df_10k_2009, on="url_cut")
final_2009_text.CIK = final_2009_text.CIK.astype(int)
final_2009_text.cik = final_2009_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2009_cik = []# This is list of CIKs that are identified as fraudulent
final_2009_text["fraud"] = np.where(final_2009_text["cik"].isin(fraud_2009_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2009_text = final_2009_text[cols]
final_2009_text['text'] = final_2009_text['text'].apply(lambda x: x.replace("\n",''))
final_2009_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2009/final_2009_text.csv", index = False)