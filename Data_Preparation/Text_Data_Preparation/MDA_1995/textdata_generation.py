...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1995"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1995"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1995"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1995/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_1995 = master_df_10k[master_df_10k["year"] == "1995"]
master_df_10k_1995["url_cut"] = master_df_10k_1995.apply(lambda row: row["url"][29:] ,axis=1)

final_1995_text = pd.merge(new, master_df_10k_1995, on="url_cut")
final_1995_text.CIK = final_1995_text.CIK.astype(int)
final_1995_text.cik = final_1995_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_1995_cik = []# This is list of CIKs that are identified as fraudulent
final_1995_text["fraud"] = np.where(final_1995_text["cik"].isin(fraud_1995_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_1995_text = final_1995_text[cols]
final_1995_text['text'] = final_1995_text['text'].apply(lambda x: x.replace("\n",''))
final_1995_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1995/final_1995_text.csv", index = False)