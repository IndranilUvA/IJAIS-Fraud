...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2011"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2011"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2011"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2011/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2011 = master_df_10k[master_df_10k["year"] == "2011"]
master_df_10k_2011["url_cut"] = master_df_10k_2011.apply(lambda row: row["url"][29:] ,axis=1)

final_2011_text = pd.merge(new, master_df_10k_2011, on="url_cut")
final_2011_text.CIK = final_2011_text.CIK.astype(int)
final_2011_text.cik = final_2011_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2011_cik = []# This is list of CIKs that are identified as fraudulent
final_2011_text["fraud"] = np.where(final_2011_text["cik"].isin(fraud_2011_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2011_text = final_2011_text[cols]
final_2011_text['text'] = final_2011_text['text'].apply(lambda x: x.replace("\n",''))
final_2011_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2011/final_2011_text.csv", index = False)