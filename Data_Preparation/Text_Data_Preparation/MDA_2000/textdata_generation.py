...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2000"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2000"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2000"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2000/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2000 = master_df_10k[master_df_10k["year"] == "2000"]
master_df_10k_2000["url_cut"] = master_df_10k_2000.apply(lambda row: row["url"][29:] ,axis=1)

final_2000_text = pd.merge(new, master_df_10k_2000, on="url_cut")
final_2000_text.CIK = final_2000_text.CIK.astype(int)
final_2000_text.cik = final_2000_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2000_cik = []# This is list of CIKs that are identified as fraudulent
final_2000_text["fraud"] = np.where(final_2000_text["cik"].isin(fraud_2000_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2000_text = final_2000_text[cols]
final_2000_text['text'] = final_2000_text['text'].apply(lambda x: x.replace("\n",''))
final_2000_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2000/final_2000_text.csv", index = False)