...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2004"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2004"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2004"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2004/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2004 = master_df_10k[master_df_10k["year"] == "2004"]
master_df_10k_2004["url_cut"] = master_df_10k_2004.apply(lambda row: row["url"][29:] ,axis=1)

final_2004_text = pd.merge(new, master_df_10k_2004, on="url_cut")
final_2004_text.CIK = final_2004_text.CIK.astype(int)
final_2004_text.cik = final_2004_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2004_cik = []# This is list of CIKs that are identified as fraudulent
final_2004_text["fraud"] = np.where(final_2004_text["cik"].isin(fraud_2004_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2004_text = final_2004_text[cols]
final_2004_text['text'] = final_2004_text['text'].apply(lambda x: x.replace("\n",''))
final_2004_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2004/final_2004_text.csv", index = False)