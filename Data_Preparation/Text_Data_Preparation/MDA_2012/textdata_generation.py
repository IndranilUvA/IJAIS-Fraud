...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2012"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2012"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2012"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2012/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2012 = master_df_10k[master_df_10k["year"] == "2012"]
master_df_10k_2012["url_cut"] = master_df_10k_2012.apply(lambda row: row["url"][29:] ,axis=1)

final_2012_text = pd.merge(new, master_df_10k_2012, on="url_cut")
final_2012_text.CIK = final_2012_text.CIK.astype(int)
final_2012_text.cik = final_2012_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2012_cik = []# This is list of CIKs that are identified as fraudulent
final_2012_text["fraud"] = np.where(final_2012_text["cik"].isin(fraud_2012_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2012_text = final_2012_text[cols]
final_2012_text['text'] = final_2012_text['text'].apply(lambda x: x.replace("\n",''))
final_2012_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2012/final_2012_text.csv", index = False)