...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2013"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2013"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2013"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2013/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2013 = master_df_10k[master_df_10k["year"] == "2013"]
master_df_10k_2013["url_cut"] = master_df_10k_2013.apply(lambda row: row["url"][29:] ,axis=1)

final_2013_text = pd.merge(new, master_df_10k_2013, on="url_cut")
final_2013_text.CIK = final_2013_text.CIK.astype(int)
final_2013_text.cik = final_2013_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2013_cik = []# This is list of CIKs that are identified as fraudulent
final_2013_text["fraud"] = np.where(final_2013_text["cik"].isin(fraud_2013_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2013_text = final_2013_text[cols]
final_2013_text['text'] = final_2013_text['text'].apply(lambda x: x.replace("\n",''))
final_2013_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2013/final_2013_text.csv", index = False)