...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2005"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2005"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2005"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2005/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2005 = master_df_10k[master_df_10k["year"] == "2005"]
master_df_10k_2005["url_cut"] = master_df_10k_2005.apply(lambda row: row["url"][29:] ,axis=1)

final_2005_text = pd.merge(new, master_df_10k_2005, on="url_cut")
final_2005_text.CIK = final_2005_text.CIK.astype(int)
final_2005_text.cik = final_2005_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2005_cik = []# This is list of CIKs that are identified as fraudulent
final_2005_text["fraud"] = np.where(final_2005_text["cik"].isin(fraud_2005_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2005_text = final_2005_text[cols]
final_2005_text['text'] = final_2005_text['text'].apply(lambda x: x.replace("\n",''))
final_2005_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2005/final_2005_text.csv", index = False)