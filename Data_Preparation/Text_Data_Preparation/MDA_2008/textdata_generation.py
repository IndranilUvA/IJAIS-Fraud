...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2008"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2008"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2008"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2008/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2008 = master_df_10k[master_df_10k["year"] == "2008"]
master_df_10k_2008["url_cut"] = master_df_10k_2008.apply(lambda row: row["url"][29:] ,axis=1)

final_2008_text = pd.merge(new, master_df_10k_2008, on="url_cut")
final_2008_text.CIK = final_2008_text.CIK.astype(int)
final_2008_text.cik = final_2008_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2008_cik = []# This is list of CIKs that are identified as fraudulent
final_2008_text["fraud"] = np.where(final_2008_text["cik"].isin(fraud_2008_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2008_text = final_2008_text[cols]
final_2008_text['text'] = final_2008_text['text'].apply(lambda x: x.replace("\n",''))
final_2008_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2008/final_2008_text.csv", index = False)