...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2001"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2001"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2001"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2001/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2001 = master_df_10k[master_df_10k["year"] == "2001"]
master_df_10k_2001["url_cut"] = master_df_10k_2001.apply(lambda row: row["url"][29:] ,axis=1)

final_2001_text = pd.merge(new, master_df_10k_2001, on="url_cut")
final_2001_text.CIK = final_2001_text.CIK.astype(int)
final_2001_text.cik = final_2001_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2001_cik = []# This is list of CIKs that are identified as fraudulent
final_2001_text["fraud"] = np.where(final_2001_text["cik"].isin(fraud_2001_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2001_text = final_2001_text[cols]
final_2001_text['text'] = final_2001_text['text'].apply(lambda x: x.replace("\n",''))
final_2001_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2001/final_2001_text.csv", index = False)