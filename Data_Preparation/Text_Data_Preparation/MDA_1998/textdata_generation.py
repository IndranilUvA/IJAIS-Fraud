...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1998"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1998"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1998"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1998/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_1998 = master_df_10k[master_df_10k["year"] == "1998"]
master_df_10k_1998["url_cut"] = master_df_10k_1998.apply(lambda row: row["url"][29:] ,axis=1)

final_1998_text = pd.merge(new, master_df_10k_1998, on="url_cut")
final_1998_text.CIK = final_1998_text.CIK.astype(int)
final_1998_text.cik = final_1998_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_1998_cik = []# This is list of CIKs that are identified as fraudulent
final_1998_text["fraud"] = np.where(final_1998_text["cik"].isin(fraud_1998_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_1998_text = final_1998_text[cols]
final_1998_text['text'] = final_1998_text['text'].apply(lambda x: x.replace("\n",''))
final_1998_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1998/final_1998_text.csv", index = False)