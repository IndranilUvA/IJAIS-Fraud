...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1994"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1994"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1994"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1994/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_1994 = master_df_10k[master_df_10k["year"] == "1994"]
master_df_10k_1994["url_cut"] = master_df_10k_1994.apply(lambda row: row["url"][29:] ,axis=1)

final_1994_text = pd.merge(new, master_df_10k_1994, on="url_cut")
final_1994_text.CIK = final_1994_text.CIK.astype(int)
final_1994_text.cik = final_1994_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_1994_cik = []# This is list of CIKs that are identified as fraudulent
final_1994_text["fraud"] = np.where(final_1994_text["cik"].isin(fraud_1994_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_1994_text = final_1994_text[cols]
final_1994_text['text'] = final_1994_text['text'].apply(lambda x: x.replace("\n",''))
final_1994_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1994/final_1994_text.csv", index = False)