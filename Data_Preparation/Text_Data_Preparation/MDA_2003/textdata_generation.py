...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2003"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2003"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2003"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2003/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2003 = master_df_10k[master_df_10k["year"] == "2003"]
master_df_10k_2003["url_cut"] = master_df_10k_2003.apply(lambda row: row["url"][29:] ,axis=1)

final_2003_text = pd.merge(new, master_df_10k_2003, on="url_cut")
final_2003_text.CIK = final_2003_text.CIK.astype(int)
final_2003_text.cik = final_2003_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2003_cik = []# This is list of CIKs that are identified as fraudulent
final_2003_text["fraud"] = np.where(final_2003_text["cik"].isin(fraud_2003_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2003_text = final_2003_text[cols]
final_2003_text['text'] = final_2003_text['text'].apply(lambda x: x.replace("\n",''))
final_2003_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2003/final_2003_text.csv", index = False)