...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1997"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1997"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\1997"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1997/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_1997 = master_df_10k[master_df_10k["year"] == "1997"]
master_df_10k_1997["url_cut"] = master_df_10k_1997.apply(lambda row: row["url"][29:] ,axis=1)

final_1997_text = pd.merge(new, master_df_10k_1997, on="url_cut")
final_1997_text.CIK = final_1997_text.CIK.astype(int)
final_1997_text.cik = final_1997_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_1997_cik = []# This is list of CIKs that are identified as fraudulent
final_1997_text["fraud"] = np.where(final_1997_text["cik"].isin(fraud_1997_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_1997_text = final_1997_text[cols]
final_1997_text['text'] = final_1997_text['text'].apply(lambda x: x.replace("\n",''))
final_1997_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/1997/final_1997_text.csv", index = False)