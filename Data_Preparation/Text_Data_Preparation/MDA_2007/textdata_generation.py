...
filepath="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2007"
filepath2="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2007"
filepath3="C:\\Users\\indra\\Desktop\\NLP Ana paper3\\Data Preparation\\2007"
...
old_file = pd.read_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2007/downloadlist.txt", sep=',', names=header_list)
...
master_df_10k_2007 = master_df_10k[master_df_10k["year"] == "2007"]
master_df_10k_2007["url_cut"] = master_df_10k_2007.apply(lambda row: row["url"][29:] ,axis=1)

final_2007_text = pd.merge(new, master_df_10k_2007, on="url_cut")
final_2007_text.CIK = final_2007_text.CIK.astype(int)
final_2007_text.cik = final_2007_text.cik.astype(str)
#### From AAER exploration, the following list is obtained from the AAER data ####
fraud_2007_cik = []# This is list of CIKs that are identified as fraudulent
final_2007_text["fraud"] = np.where(final_2007_text["cik"].isin(fraud_2007_cik), 1 , 0)

cols = ['cik','filing_date', 'url','month', 'year', 'date','text','fraud']
final_2007_text = final_2007_text[cols]
final_2007_text['text'] = final_2007_text['text'].apply(lambda x: x.replace("\n",''))
final_2007_text.to_csv("C:/Users/indra/Desktop/NLP Ana paper3/Data Preparation/2007/final_2007_text.csv", index = False)